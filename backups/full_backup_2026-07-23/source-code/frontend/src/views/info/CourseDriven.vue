<template>
  <div class="info-page">
    <div class="info-container">
      <h1 class="info-title">Course Driven</h1>
      <div class="info-content">
        <p class="info-lead">THE OUTNET is course-driven — guided by clear objectives, measurable outcomes, and continuous improvement in everything we do.</p>
        <h2>Our Approach</h2><p>We set clear strategic courses across all departments, from technology to operations, ensuring alignment with our overall mission and goals.</p><h2>Key Initiatives</h2><ul><li>Platform innovation and user experience enhancement</li><li>Expanding brand and supplier partnerships</li><li>Global market penetration</li><li>Customer experience excellence</li></ul><h2>Measuring Success</h2><p>We track key performance indicators across all initiatives, regularly reviewing and adjusting our course to ensure we stay on track.</p>
      </div>
    </div>
  </div>
</template>
