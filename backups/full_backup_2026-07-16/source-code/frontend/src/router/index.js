...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'chatwoot-settings', name: 'admin-chatwoot-settings', component: () => import('@/views/admin/AdminChatwootSettings.vue'), meta: { title: 'Chatwoot Chat', requiresAuth: true, adminLayout: true } },
...
const adminPathMap = {
  ...
  '/admin-submissions': '/admin/submissions',   '/admin-tawkto-settings': '/admin/tawkto-settings', '/admin-chatwoot-settings': '/admin/chatwoot-settings',
