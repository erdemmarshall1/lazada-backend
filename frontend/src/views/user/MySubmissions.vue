<template>
  <div>
    <h3>My Inquiries</h3>
    <p v-if="!list.length && !loading" class="empty-text">You haven't submitted any inquiries yet.</p>
    <el-table :data="list" v-loading="loading" style="width:100%" size="small">
      ...
      <el-table-column label="Action" width="80">
        <template #default="{row}">
          <el-button size="small" text @click="selected = row; dialogVisible = true">View</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog v-model="dialogVisible" title="Inquiry Detail" width="500px">
      <div v-if="view">
