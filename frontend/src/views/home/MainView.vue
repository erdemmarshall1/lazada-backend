            ...
            <div class="home-hots-box">
              ...
              <div class="home-hots-content">
                <div class="home-hots-item" v-for="item in hotProducts" :key="item._id" @click="goDetail(item._id)">
                  <img class="home-hots-img" :src="$imgUrl(item.images?.[0])" :alt="item.name" loading="lazy" @error="$imgFallback" />
...
.page {
  ...
  background: #f7f7f7;
  overflow: visible;
  font-family: 'TheOutnetWebXL', 'Helvetica Neue', 'PingFang SC', 'Microsoft YaHei', Arial, sans-serif;
}
